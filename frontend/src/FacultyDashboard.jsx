      ...
      <main className="md:ml-64 p-margin-mobile md:p-margin-desktop max-w-[1400px] mx-auto min-h-screen pb-24">
        ...
        {activeTab === "reports" && (
          <div className="flex flex-col w-full">
              ...
              <div className="p-6 flex flex-col justify-between">
                ...
                <div className="mt-4">
                  <div className="font-greeting-serif text-[42px] leading-tight text-on-surface font-bold">
                    {lectures.length > 0 ? lectures.length * 15 + 16 : 76}
                  </div>
                  <div className="flex items-center gap-1.5 mt-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-border-default divide-y lg:divide-y-0 lg:divide-x divide-border-default">
            ...
            {/* Live Session Roster Inspection Box */}
            <div className="p-6 bg-surface-warm border-b border-border-default space-y-4">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-border-default font-body-md text-body-md text-on-surface">
                    ...
                    <tr className="hover:bg-surface-warm/80 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        <div className="inline-flex items-center gap-2">
                          <button
                            onClick={() => alert("Formal Citation Slip #CIT-901 generated for Jay Mehta.")}
                          ...
                          <button
                            onClick={() => alert("Pardon duty / compensatory medical leave granted.")}
                            className="px-2.5 py-1 bg-secondary text-on-secondary hover:opacity-90 font-label-sm text-label-sm transition-all cursor-pointer"
                    ...
                    <tr className="hover:bg-surface-warm/80 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        <button
                          onClick={() => alert("Absences review window opened for Vikram Rao.")}
                          className="px-2.5 py-1 bg-surface-container-high hover:bg-border-default text-on-surface font-label-sm text-label-sm transition-colors cursor-pointer"
                          type="button"
                        >
                          Review Absences
              ...
              <div className="lg:col-span-4 p-6 bg-surface-warm flex flex-col justify-between">
                <div>
                  ...
                  <div className="mt-6 p-4 bg-surface-container-lowest border border-border-default">
                    ...
                    <div className="font-mono text-label-sm text-on-surface break-all mt-1">
                    ...
                    <div className="flex items-center gap-1.5 mt-2 text-label-sm text-text-stone">
                      ...
                      <span>Tamper-evident system timestamp: Nov 14, 2026 10:45 AM</span>
                    </div>
                  </div>
                </div>
                <div className="mt-8 pt-4 border-t border-border-default">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="font-label-sm text-label-sm text-text-stone">Professor & Chair</div>
                    </div>
                    <button
                      onClick={() => alert("Report digitally signed with RSA key and transmitted to Registrar Office.")}
                      className="px-3.5 py-2 bg-on-surface text-surface-container-lowest hover:opacity-90 font-label-md text-label-md transition-all flex items-center gap-2 cursor-pointer font-semibold"
                      type="button"
                    >
